...
$execute{
  ...
  if (!bot.mod->setSavedValue("button_defaults5", true)) {
    cocos2d::CCSize winSize = CCDirector::sharedDirector()->getWinSize();

    bot.mod->setSavedValue("button_off_pos_x", 62.f);
    bot.mod->setSavedValue("button_off_pos_y", winSize.height - 35.f);
    bot.mod->setSavedValue("button_off_scale", 1.f);
    bot.mod->setSavedValue("button_off_opacity", 1.f);

    bot.mod->setSavedValue("button_advance_frame_pos_x", 100.f);
    bot.mod->setSavedValue("button_advance_frame_pos_y", winSize.height - 50.f);
    bot.mod->setSavedValue("button_advance_frame_scale", 0.9f);
    bot.mod->setSavedValue("button_advance_frame_opacity", 1.f);

    bot.mod->setSavedValue("button_backstep_frame_pos_x", 138.f);
    bot.mod->setSavedValue("button_backstep_frame_pos_y", winSize.height - 50.f);
    bot.mod->setSavedValue("button_backstep_frame_scale", 0.9f);
    bot.mod->setSavedValue("button_backstep_frame_opacity", 1.f);

    bot.mod->setSavedValue("button_speedhack_pos_x", winSize.width - 62.f);
    bot.mod->setSavedValue("button_speedhack_pos_y", winSize.height - 38.f);
    bot.mod->setSavedValue("button_speedhack_scale", 1.f);
    bot.mod->setSavedValue("button_speedhack_opacity", 1.f);
  }

  if (!bot.mod->setSavedValue("button_defaults6", true)) {
    cocos2d::CCSize winSize = CCDirector::sharedDirector()->getWinSize();
